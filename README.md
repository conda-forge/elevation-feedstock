...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/elevation-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=6991&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/elevation-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `elevation` can be installed with:

```
conda install elevation
```

It is possible to list all of the versions of `elevation` available on your platform with:
